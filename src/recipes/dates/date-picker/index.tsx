...
import { DatePickerProps, State } from "../types";
import {
  DatePickerEditDisplayProps,
  DatePickerReadDisplayProps,
} from "./types";
    ...
    <Stack>
      ...
      <Calendar
        ...
        onMonthChanged={({ month }) =>
          dispatch(createOnMonthChangedAction({ value: month }))
        }
        onYearChanged={({ year }) =>
          dispatch(createOnYearChangedAction({ value: year }))
        }
      />
    </Stack>
  </Box>
