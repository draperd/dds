...
const Shape = ({ }) => (
  <div style={{ backgroundColor: 'orange', height: '100%', width: '100%'}}>Shape</div>
);
...
Basic.args = {
  ...
  childrenForSmallDesktopDisplay: (<>
                                ...
                                <GridItem columnSpan={4} rowSpan={2}><div>Metadata</div></GridItem>
                                <GridItem columnSpan={6}><div>Comments</div></GridItem>
                              </>),
  childrenForLargeDesktopDisplay: (<>
                                    ...
                                    <GridItem columnSpan={6}>
                                      <SubGrid columns={6}>
                                        {renderShapes({prefix: 'a', count: 2})}
                                      </SubGrid>
                                    </GridItem>
                                    <GridItem columnSpan={3} rowSpan={1}><div>Metadata</div></GridItem>
                                    <GridItem columnSpan={3}><div>Comments</div></GridItem>
                                  </>)
};
